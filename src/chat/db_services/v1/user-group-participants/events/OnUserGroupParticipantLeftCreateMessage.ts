...
/**
 * On participant removed create the message of type action.
 * @param result
 * @param context
 * @constructor
 */
const OnUserGroupParticipantLeftCreateMessage = async (result: UserGroupParticipant_GET, context: HookContext) => {
    ...
    if (participantData._id.toString() === userData._id.toString()) {
        ...
        const messageData: Message_POST = {
            ...
            text: groupData.parentId ? `You left the channel.` : `You left the group.`,
        ...
        const messageDataForOtherParticipants: Message_POST = {
            ...
            text: groupData.parentId
                ? `${participantData.firstName} left the channel`
                : `${participantData.firstName} left the group`,
            entityType: MessageEntityType.USER_GROUP,
            entityId: groupData._id,
            sender: userData._id,
        };
        ...
        const messageData: Message_POST = {
            type: MessageType.ACTION,
            text: `${userData.firstName} removed you`,
            entityType: MessageEntityType.USER_GROUP,
            entityId: groupData._id,
            sender: userData._id,
        ...
        const messageDataForCreator: Message_POST = {
            type: MessageType.ACTION,
            text: `You removed ${participantData.firstName}`,
            entityType: MessageEntityType.USER_GROUP,
            entityId: groupData._id,
            sender: userData._id,
            recipients: [userData._id],
        ...
        const messageDataForOtherParticipants: Message_POST = {
            type: MessageType.ACTION,
            text: `${userData.firstName} removed ${participantData.firstName}`,
            entityType: MessageEntityType.USER_GROUP,
            entityId: groupData._id,
            sender: userData._id,
        };
...
export default OnUserGroupParticipantLeftCreateMessage;
