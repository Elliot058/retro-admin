...
const GetAllPinnedMessagesOfGroup = () => async (context: HookContext) => {
    ...
    context.result = await pinMessageService.Model.aggregate([
        {
            $match: {
...
export default GetAllPinnedMessagesOfGroup;
